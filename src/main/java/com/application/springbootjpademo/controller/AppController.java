package com.application.springbootjpademo.controller;
...
public class AppController {
    ...
    @GetMapping("/{blogId}")
    public ResponseEntity<Blog> getBlogByName(String blogName) throws BlogNotFoundException {
    ...
    @PutMapping("/{blogId}")
    public ResponseEntity<?> deleteBlog(@RequestBody Blog blog,@PathVariable("blogId") int blogId) throws BlogNotFoundException {
